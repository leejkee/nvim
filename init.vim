...
set tabstop=4
" a <tab> will be replaced four <space>s when typing <tab>
set shiftwidth=4
...
call plug#begin('/home/leh/.config/nvim/plugged/')
...
" ===        Map        ===
" =========================
" Leader key has been set in line 32.
" press space+e to open the tree
nnoremap <LEADER>e :NERDTreeToggle<CR>
" pressing 's' means nothing
map s <nop>
